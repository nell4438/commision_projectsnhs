...
<form class="form-horizontal span6" action="controller.php?action=add" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="SUBJ_CODE" name="SUBJ_CODE" placeholder="Subject" type="text" value="">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="SUBJ_DESCRIPTION">Description:</label>

      <div class="col-md-8">

        <input class="form-control input-sm" id="SUBJ_DESCRIPTION" name="SUBJ_DESCRIPTION" placeholder="Description"
          type="text" value="">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="UNIT" name="UNIT" placeholder="Unit" type="text" value="" required>
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="PRE_REQUISITE" name="PRE_REQUISITE" placeholder="Pre-Requisite"
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="COURSE_ID">Course:</label>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="AY" name="AY" placeholder="Academic Year" type="text" value=""
          required>
      </div>
    </div>
  </div>
