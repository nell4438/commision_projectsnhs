...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Update Year Level</h1>
    </div>
    <!-- /.col-lg-12 -->
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="COURSE_MAJOR">Subject:</label>

      <div class="col-md-8">

        <input class="form-control input-sm" id="COURSE_MAJOR" name="COURSE_MAJOR" placeholder="Subject" type="text"
    ...
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="COURSE_DESC" name="COURSE_DESC" placeholder="Year Level Description"
          type="text" value="<?php echo $singlecourse->COURSE_DESC; ?>" required>
      </div>
    </div>
  </div>
