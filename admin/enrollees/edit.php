...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
  ...
  <input class="form-control input-sm" id="COURSE_ID" name="COURSE_ID" placeholder="Account Id" type="Hidden" value="<?php echo $singlecourse->COURSE_ID; ?>">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="COURSE_NAME" name="COURSE_NAME" placeholder="Course" type="text" value="<?php echo $singlecourse->COURSE_NAME; ?>">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="COURSE_LEVEL" name="COURSE_LEVEL" placeholder="Course Level" type="text" value="<?php echo $singlecourse->COURSE_LEVEL; ?>">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        ...
        <input class="form-control input-sm" id="COURSE_MAJOR" name="COURSE_MAJOR" placeholder="Major" type="text" value="<?php echo $singlecourse->COURSE_MAJOR; ?>" required>
      </div>
    </div>
  </div>
