...
function sendUploadReminder($emailReceiver)
{
	...
	try {
		...
		$mail->Body = 'Dear student, <br><br> Please remember to upload your Credentials. This is a necessary document for your enrollment.<br><br>This is a system-generated email. Please do not reply.';
...
if (isset($_POST['regsubmit'])) {
	...
	$_SESSION['COURSEID'] = $_POST['COURSE'] ?? 0;
	...
	// print_r($res);
	// print_r($userStud['IDNO']);
	// return 0;
	if ($res && $userStud) {

		$_SESSION['STUDID'] = $userStud['IDNO'];
		// update -> old student
		...
		$studentdetails->update($userStud['IDNO']);
	...
	<div class="table-responsive">
		...
		<table class="table">
			<tr>
				...
				<td>
					<input class="form-control input-md" readonly id="IDNO" name="IDNO" placeholder="Student Id"
						type="text"
						value="<?php echo isset($_SESSION['STUDID']) ? $_SESSION['STUDID'] : $autonum->AUTO; ?>">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				...
				<td colspan="2">
					<input required="true" class="form-control input-md" id="LNAME" name="LNAME" placeholder="Last Name"
						type="text" value="<?php echo isset($_SESSION['LNAME']) ? $_SESSION['LNAME'] : ''; ?>">
				</td>
				<td>
					<input class="form-control input-md" id="MI" name="MI" placeholder="MI" maxlength="1" type="text"
			...
			<tr>
				...
				<td colspan="5">
					<input required="true" class="form-control input-md" id="PADDRESS" name="PADDRESS"
						...
						value="<?php echo isset($_SESSION['PADDRESS']) ? $_SESSION['PADDRESS'] : ''; ?>">
				</td>
			</tr>
			<tr>
				...
				<td colspan="5">
					<div class="input-group">
						...
						<input required="true" name="BIRTHDATE" id="BIRTHDATE" type="date" class="form-control input-md"
							max="<?php echo date('Y-m-d'); ?>"
							value="<?php echo isset($_SESSION['BIRTHDATE']) ? $_SESSION['BIRTHDATE'] : ''; ?>">
					</div>
				</td>
			...
			<tr>
				...
				<td colspan="5">
					<input required="true" class="form-control input-md" id="BIRTHPLACE" name="BIRTHPLACE"
						...
						value="<?php echo isset($_SESSION['BIRTHPLACE']) ? $_SESSION['BIRTHPLACE'] : ''; ?>">
				</td>
			</tr>
			<tr>
				...
				<td colspan="2"><input required="true" class="form-control input-md" id="NATIONALITY" name="NATIONALITY"
						...
						value="<?php echo isset($_SESSION['CONTACT']) ? $_SESSION['CONTACT'] : ''; ?>">
				</td>
			...
			<tr>
				...
				<td colspan="5">
					<input required="true" class="form-control input-md" id="CONTACT" name="CONTACT"
						placeholder="Contact Number" type="tel" maxlength="11" oninput="validateInput(this)"
						value="<?php echo isset($_SESSION['CONTACT']) ? $_SESSION['CONTACT'] : ''; ?>">
			...
			<tr>
				...
				<td colspan="2">
					<select class="form-control input-sm" name="YEARLEVEL" id="yearLevelSelect"
						onchange="showHideStrandField()">
						<?php
						for ($i = 7; $i <= 12; $i++) {
			...
			<tr>
				...
				<td colspan="2">
					<input required="true" class="form-control input-md" id="USER_NAME" name="USER_NAME"
						placeholder="Email Address" type="text"
						value="<?php echo isset($_SESSION['USER_NAME']) ? $_SESSION['USER_NAME'] : ''; ?>">
				</td>
				<td><label>Password</label></td>
				<td colspan="2">
					<input required="true" class="form-control input-md" id="PASS" name="PASS" placeholder="Password"
						type="password" value="<?php echo isset($_SESSION['PASS']) ? $_SESSION['PASS'] : ''; ?>">
				</td>
			</tr>
			<tr>
				...
				<td><label>Contact No.</label></td>
				<td colspan="5">
					<input required="true" class="form-control input-md" id="GCONTACT" name="GCONTACT"
						placeholder="Contact Number" type="tel" maxlength="11" oninput="validateInput(this)"
