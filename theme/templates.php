...
<title><?php echo $title; ?> | Sto.Nino National High School</title>
...
<body style="background-color: #097687; background-image: url('img/banner1.jpeg');">

<div class="navbar-fixed-top navbar-TOPsm  col-md-10    col-md-offset-1"    role="navigation" style="background-color:#097687;">
  <div class="container">
     <!-- Navigation -->
     <nav class="navbar navbar-default navbar-static-top" style="background-color:#097687;color:#fff;" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
       <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="sr-only">Toggle navigation</span>
        </button>
        <a class="navbar-brand" style="background-color:#097687;color:#fff;" href="<?php echo web_root; ?>admin/index.php" > 
        <img src="<?php echo web_root; ?>img/logosnhs.png" height="30">
        Sto.Nino National High School</a>
    </div>
    <!-- /.navbar-header -->
      <div  class="collapse navbar-collapse  smMenu " style="background-color:#097687;"> 
   ...
   <div class="col-md-4">
    <div class="row ">  -->
     <!-- <p > 
        ...
        <h1 align="center" >Sto.Nińo Nationall High School</h1>
        </a>
    </p> -->
 ...
 <div class="navbar navbar-static-top navbar-magbanua col-md-10 col-md-offset-1 " style="background-color:#097687;"    role="navigation">
...
<?php
  ...
  ?>
        <div class="collapse navbar-collapse bigMenu" style="background-color:#097687;" > 
          <ul class="nav navbar-nav menu" style="margin-left:-4%;"    > 

          <!-- <ul class="nav navbar-nav" >  -->
          <li class="dropdown <?php echo (isset($_GET['q']) && $_GET['q']=='') ? 'active' : ''; ?>">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">Home <b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li class="<?php echo (isset($_GET['q']) && $_GET['q']=='department') ? 'active' : ''; ?>">
          <a href="<?php echo web_root.'index.php?q=department'; ?>">Strands</a>
        </li>
    ...
    <!-- Enroll Now! - Non-dropdown -->
    <li class="<?php echo (isset($_GET['q']) && ($_GET['q']=='enrol' || $_GET['q']=='subject')) ? 'active' : ''; ?>">
            ...
            <div class="row">
              <div class="col-lg-9">
                <div class="panel panel-default">
                  <div class="panel-heading" style="background-color:#097687;color:#fff;">
                  <b><?php   
...
?>
            ...
            <footer class="panel-footer" style="background-color:#097687;color:#fff;" >
              <p align="left" >&copy; Sto.Nino National High School</p>
           </footer>
      </div>
